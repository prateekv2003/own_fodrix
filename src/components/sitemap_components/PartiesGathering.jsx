      ...
      <div className="row">
        <div className="col-lg-7 col-xl-6 container min-vh-lg-90  align-items-center  p-sm-4  text_sitemap">
          <h1 className="sitemap_component_text">
            {" "}
            Exciting Gatherings and Parties photography made effortless!!!
          </h1>
          <p className="content_sitemap">
            Capture your eventful memories professionally by hiring professional
            photographers from fodrix with prices starting from...
          </p>
...
export default PartiesGathering;
