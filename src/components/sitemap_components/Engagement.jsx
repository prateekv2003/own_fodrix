      ...
      <div className="row">
        <div className="col-lg-7 col-xl-6 container min-vh-lg-90  align-items-center  p-sm-4  text_sitemap">
          <h1 className="sitemap_component_text">
            {" "}
            Beautiful Engagement Photoshoots made unbelievably easy!!!
          </h1>
          <p className="content_sitemap">
            Book our extremely professional photographers to capture the best
            moments in life with shoots starting with just….
          </p>
