      ...
      <div className="row">
        <div className="col-lg-7 col-xl-6 container min-vh-lg-90  align-items-center  p-sm-4  text_sitemap">
          <h1 className="sitemap_component_text">
            {" "}
            Cute Pet Photography made unbelievably easy!!!
          </h1>
          <p className="content_sitemap">
            Book an expert photographer to click on some of the best pictures of
            your sweet and furry pets! Photoshoots made affordable by starting
            just from…
          </p>
          ...
          <Typewriter
            onInit={(typewriter) => {
              typewriter
                ...
                .typeString("For your kids")
                .pauseFor(2000)
                .deleteAll()
                .typeString("For your Business")
                .pauseFor(2000)
                .deleteAll()
                .typeString("For your Wedding")
