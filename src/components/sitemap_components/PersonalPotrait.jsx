      ...
      <div className="row">
        <div className="col-lg-7 col-xl-6 container min-vh-lg-90  align-items-center  p-sm-4  text_sitemap">
          <h1 className="sitemap_component_text">
            {" "}
            Flawless Portraits made flawlessly smooth!!!
          </h1>
          <p className="content_sitemap">
            Book a professional photographer to capture your professional look
            through portrait photographs, photoshoots starting just at….
          </p>
...
export default PersonalPotrait;
