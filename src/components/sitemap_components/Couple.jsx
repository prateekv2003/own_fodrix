      ...
      <div className="row">
        <div className="col-lg-7 col-xl-6 container min-vh-lg-90  align-items-center  p-sm-4  text_sitemap">
          <h1 className="sitemap_component_text">
            {" "}
            Amazing couple photography made hassle-free!!!
          </h1>
          <p className="content_sitemap">
            Book professional photographers from fodrix to click the best
            pictures of you with your significant other with prices starting
            just at...
          </p>
