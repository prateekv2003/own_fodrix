      ...
      <div className="row">
        <div className="col-lg-7 col-xl-6 container min-vh-lg-90  align-items-center  p-sm-4  text_sitemap">
          <h1 className="sitemap_component_text">
            Eventful Kids Party Photoshoots made significantly simple!!!
          </h1>
          <p className="content_sitemap">
            Book a professional photographer to capture all the joyful and
            unforgettable moments of your kid’s party with a photoshoot starting
            just from…
          </p>
